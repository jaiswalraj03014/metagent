 ...
 */ class BaseWebhooks extends APIResource {
     ...
     */ create(params, options) {
        const { api_version = this._client.apiVersion, webhook_id } = params, body = __rest(params, [
            "api_version",
            "webhook_id"
        ]);
     ...
     */ update(id, params, options) {
        const { api_version = this._client.apiVersion, update_mask } = params, body = __rest(params, [
            "api_version",
            "update_mask"
        ]);
